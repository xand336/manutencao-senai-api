...
public class TecnicoService {
	...
	public List<Tecnico> listarPor(@NotEmpty
			(message = "O nome para a busca não pode ser nula") String nome) {
		return new ArrayList<Tecnico>();
	}
	
	public void removerPor(@NotNull(message = "O id de exlusão não pode ser nulo")
